# Let Skill Train Itself: 8-Stage Loop, 3-Tier Evaluation, 5-Dimensional AND Gating for Self-Evolution

- BestBlogs URL: https://www.bestblogs.dev/article/8fdfe4e8
- Original publisher URL: https://mp.weixin.qq.com/s?__biz=MzI2NDU4OTExOQ==&mid=2247695568&idx=1&sn=492ca1e98155a9fea668213173cab654
...
关注腾讯云开发者，一手技术干货提前解锁👇
  ...
  稳定性。 你加了一个看起来特别对的安全检查，比如「git 状态不干净就拒绝执行」。所有测试都过了。但用户那边一个全新的、还没git init的 skill 目录，直接报错退出。你自己测不出来，因为你的测试环境里所有 skill 都已经在 git 下面了。
