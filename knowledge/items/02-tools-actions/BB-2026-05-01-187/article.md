# How Anthropic's cybersecurity team built a threat detection platform with Claude Code | Claude

- BestBlogs URL: https://www.bestblogs.dev/en/article/5087293a
- Extraction: BestBlogs API proxy content endpoint + rendered rich text body
- Extracted chars: 10932
- Original publisher URL: https://claude.com/blog/how-anthropic-uses-claude-cybersecurity
