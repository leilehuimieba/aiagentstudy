# Fiona Fung, Engineering Lead at Claude Code: How to Build the Most AI-Native Engineering Team?

- BestBlogs URL: https://www.bestblogs.dev/article/e67ff5dc
- Original publisher URL: https://mp.weixin.qq.com/s?__biz=MzAxMDMxOTI2NA==&mid=2649109536&idx=1&sn=bc784fdeb9790f763fd274666c6975b7
- Source: BestBlogs / 十字路口Crossing
- Publish time: 2026-06-27 11:21:00
...
过去让你成功的，未必还能带你往前。
   ...
   所以这是一种管理手法：交付产品的同时，能更清楚团队产出的实际影响？
   ...
   别的 labs 我没待过，但我们很关注潜在需求（latent demand）：编码这个用例我们自己就是第一批用户，反馈很快；后来又注意到很多非程序员在用 Claude Code，于是想把那段体验做得更好，这才有了 Cowork。我自己对小微企业也一直有兴趣，走访过几家后，团队真的做出了打包好的 Claude for Small Business。
   ...
   我们在往异步（async）走。以前我是同步发一个 prompt、最多手动开几个并行的；现在我能用一个 Routine 来替我生成这些 prompt，抽象的层级一直在往上抬。
   ...
   也许有一天这不重要了，但以现在的节奏，我仍然建议要往下去深挖一层、去看清你依赖的那一层。这样依赖一变，你更清楚，也不会错过它带来的新能力。
