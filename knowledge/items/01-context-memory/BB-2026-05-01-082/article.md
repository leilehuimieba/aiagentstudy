...
- BestBlogs URL: https://www.bestblogs.dev/article/6738cfeb
- Extraction: DOM text from BestBlogs page via OpenCLI browser bridge
- Extracted chars: 4668
- Original publisher URL: https://baoyu.io/blog/2026-04-24/teddy-riker-2047312986696454584
...
每次工具调用都要求填写“理由”。 每一次 MCP 或 CLI 工具调用，都要求 AI 智能体带上一个 rationale 参数，解释它为什么要发起这个请求。我们看不到聊天内容，但这个理由可以重建意图。理由里的模式，会告诉我们用户到底想做什么。
