...
- BestBlogs URL: https://www.bestblogs.dev/article/52f8c2e7
- Extraction: DOM text from BestBlogs page via OpenCLI browser bridge
- Extracted chars: 8749
- Original publisher URL: https://openai.com/index/speeding-up-agentic-workflows-with-websockets
...
After a two-month sprint building WebSocket mode, we launched an alpha with key coding agent startups so they could integrate it into their infrastructure and safely ramp up traffic. Alpha users loved it, reporting up to 40% improvements⁠
(opens in a new window)
 in their agentic workflows. Given the positive alpha feedback, we were ready to launch.
...
Codex quickly ramped the majority of their traffic onto WebSockets. Codex users running the latest models such as GPT‑5.3‑Codex⁠
(opens in a new window)
, GPT‑5.4⁠
(opens in a new window)
, and beyond all benefit from WebSocket mode’s speed up.
