# Turing Award Winner Bets $1 Billion on AI's Next Decade (Part 1)

- BestBlogs URL: https://www.bestblogs.dev/article/572cef4c
- Original publisher URL: https://mp.weixin.qq.com/s?__biz=MzAxMDMxOTI2NA==&mid=2649109099&idx=1&sn=bdc8a94d8008b825254f0df162294ed6
- Source: BestBlogs / 十字路口Crossing
- Publish time: 2026-06-14 12:47:00
...
他第一次把完整的逻辑讲清楚了。
   ...
   但当大部分人扑在强化学习上时，Ilya Sutskever、Alec Radford 等人却对来自 Google 的一种新神经网络架构 Transformer 产生了兴趣，它最初是为机器翻译而设计。
   ...
   把这个思想应用于网络输出上，就得到 Barlow Twins：
   ...
   此后简化版的 VICReg、以及 FAIR 巴黎的 DINO 系列接力推进，直到 2025 年 8 月的 DINO V3，自监督模型首次在图像分类上追平弱监督/监督模型（88.4%）。
