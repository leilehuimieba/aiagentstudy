...
Software engineering is the design and construction of reliable, maintainable systems. It requires judgment about architecture, testing strategy, operational concerns, and the long-term consequences of current decisions. Code is the medium, and the system is the product.
...
The Bitter Lesson — Rich Sutton. Essential reading for understanding why general models outperform specialized systems.

A Philosophy of Software Design — John Ousterhout. The clearest account of what makes software maintainable.

Fundamentals of Software Architecture — Mark Richards and Neal Ford. Practical treatment of architectural decision-making.
