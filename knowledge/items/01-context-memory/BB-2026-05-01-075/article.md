# 在 Claude Code 中使用 Claude Opus 4.7 的最佳实践 | Claude | BestBl...

- BestBlogs URL: https://www.bestblogs.dev/article/59c28b8d
- Extraction: DOM text from BestBlogs page via OpenCLI browser bridge
- Extracted chars: 7440
- Original publisher URL: https://claude.com/blog/best-practices-for-using-claude-opus-4-7-with-claude-code
...
Based on our internal evals, Opus 4.7 outperforms Opus 4.6 across the full effort range, with the largest gains at high and Extended Thinking settings.
