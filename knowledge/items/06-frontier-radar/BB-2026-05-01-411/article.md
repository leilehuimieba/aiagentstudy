# Founder's Honest Retrospective: 10 Key Decisions in 300 Days of AI Application Entrepreneurship

- BestBlogs URL: https://www.bestblogs.dev/article/9ddb98e2
- Original publisher URL: https://mp.weixin.qq.com/s?__biz=MzA3NTQ4NjczNw==&mid=2650680482&idx=2&sn=52284fb1c1fa431f9e9be493a5479187
- Source: BestBlogs / 白鲸出海
- Publish time: 2026-05-26 21:30:00
...
非常真实地讲述了一个 Agent 创业团队，在焦虑和迷茫中探索方向和转向的过程。
  ...
  锦秋基金于 2025 年已完成对 SophiaPro 的投资。

  锦秋基金在不确定中长期支持想要改变世界的创业者，一起创造独一无二的伟大公司。

  

  SophiaPro 成立于 2025 年 6 月，最早的产品为 Karis.im ，致力于为出海企业提供市场营销数字员工。而后转向 C 端产品方向，推出 浏览器插件TryClico 和 桌面端产品 Invoko.ai。

  SophiaPro 的创始人程梦琪表示：

  “锦秋是我们的第一轮投资人，给了我们非常大的帮助。我身边也问过其他创业者，他们的一些投资人会包经常找你，包装成关心你，但实际上是在催你。但锦秋不是这样，他们不光给钱，还给了我们业务，给了很多机会。最难熬的那段时间，他们比较关爱我的心理健康。而且他们很少跟我输出那种泛泛而谈的建议。我真的非常喜欢锦秋，这很像一个👪︎family。如果大家在考虑找投资人，我觉得值得认真考虑他们。”

  特朗普，金色假发，嘟着嘴，在 MacBook 屏幕顶部的灵动岛里，左右跳动。

  这是一个 Invoko 用户最新的小需求。

  Invoko 是一款桌面端 AI 助手。它的 IP 是一朵蓝色的云☁️，长在 Mac 灵动岛的位置，你按下去它会回应你。不管你正在写邮件，还是需要 Slack 里同事刚发的数据，或者要参考飞书文档里的方案，都无需在三个窗口之间来回切，只需要和这朵云说一句话就行。

  在锦秋小饭桌（Google 特别场）上，创始人程梦琪是笑着讲出这个用户需求的。

  

  此时这款产品上线不到三个月，已经有用户在问能不能买皮肤、能不能给那朵云戴墨镜。

  但就在两个月前，她坐在电脑前盯着满屏的软件，觉得做这件事可能没有“意义”。AI 能力在以周为单位地进化，今天你做的任何功能，明天就可能被模型厂商自己覆盖掉。

  Invoko 是程梦琪创业快三百天以来的第四个产品。在它之前，程梦琪还做了一个没跑通的 ToB 营销 Agent，一个她起初根本看不上的浏览器插件，但也出乎意料的得到了很多好评。

  她说自己不是什么明星创业者，正好也没什么包袱，所以在活动上她完整地讲了这接近 300 天，怎么从垂直 Agent 转到 workflow，从面向 B 端到面向 C 端，踩了哪些坑，交了哪些学费，以及怎么从“觉得做软件的人脑子进水了”重新变得对这件事充满热情。

  这是一个真实的、没有滤镜的 AI 应用创业者的故事。

  程梦琪和我们想把它分享出来，是因为在这个所有人都在焦虑“AI 时代到底该怎么做产品”的时刻，一个创业者的真实经历，往往比一百条方法论更有启发。

  以下为 SophiaPro 创始人程梦琪在 锦秋小饭桌 XGoogle 的活动上的分享。略有删减、调整。
  ...
  但我们当时还讲了一个更“性感”的故事：coding 有明确的 reward 信号，数学也有，那下一个有点反馈信号的领域是什么？是 marketing，因为你发的内容天然有曝光和互动率，你能拿到信号来训模型。
  ...
  两类人的需求完全不一样。当时市面上很火的概念是“蒸馏专家经验”，把高认知能力浓缩成产品，再卖给非专业的人。我们觉得应该先服务专业用户，把他们的经验蒸馏出来。
  ...
  2月份我跑去旧金山，把那边做垂直 Agent 的公司聊了一遍。大概一百家公司，困境都很相似。而且我发现大部分创业公司连基本的 ToB 组织都建不起来，我问他们你知道 CSM 是什么吗，一半人不知道。很多技术背景创业者对 ToB 的理解就是“我身边有两个朋友我劝他用一下”，互相买、互帮互助刷到 100 万美金ARR。但到了 100 万之后，集体性的迷茫。
  ...
  关于公司组织。我们现在没有产品经理。不是不需要这个角色，是在这个时代我还没想好产品经理应该干什么。研发流程是：用户报 bug，扔给 Agent，Agent 分配到研发同学本地的 coding Agent，自动修，人做测试验收。增长侧有各种skill在跑自动化。组织尽可能简单、沟通尽可能短，每个人都能 connect 到 repo。
