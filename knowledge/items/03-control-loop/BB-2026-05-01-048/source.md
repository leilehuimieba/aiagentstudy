...
- Browser title: Codex CLI 0.128.0 新增 /goal 命令 | BestBlogs.dev
- Description: OpenAI 的 Codex CLI 0.128.0 引入了 `/goal` 命令，使智能体能够自主循环，直到达成定义的目标或耗尽令牌预算，实现了类似于 Ralph 循环的概念。
- Date: 2026-04-30
...
- 查看原文 →: https://simonwillison.net/2026/Apr/30/codex-goals/#atom-everything
- Codex CLI 0.128.0 adds /goal: https://github.com/openai/codex/releases/tag/rust-v0.128.0
- Ralph loop: https://ghuntley.com/ralph/
- goals/continuation.md: https://github.com/openai/codex/blob/6014b6679ffbd92eeddffa3ad7b4402be6a7fefe/codex-rs/core/templates/goals/continuation.md
- goals/budget_limit.md: https://github.com/openai/codex/blob/6014b6679ffbd92eeddffa3ad7b4402be6a7fefe/codex-rs/core/templates/goals/budget_limit.md
...
- GPT-5.5 发布: https://www.bestblogs.dev/article/a6d9083a?entry=related_article
- OpenAI 发布 GPT-5.3-Codex: https://www.bestblogs.dev/status/2019474152743223477?entry=related_article
- GPT-5.4 mini 和 GPT-5.4 nano：76，000 张照片仅需 52 美元: https://www.bestblogs.dev/article/eedde830?entry=related_article
- OpenAI 发布 GPT-5.4：支持原生计算机使用与 100 万 token 上下文: https://www.bestblogs.dev/status/2029622732594499630?entry=related_article
- 这就是 ChatGPT 图像 2.0: https://www.bestblogs.dev/video/f12b487?entry=related_article
