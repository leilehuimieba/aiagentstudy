...
- BestBlogs URL: https://www.bestblogs.dev/article/b816f49d
- Extraction: DOM text from BestBlogs page via OpenCLI browser bridge
- Extracted chars: 51547
- Original publisher URL: https://mp.weixin.qq.com/s?__biz=MzIxODUzNTg2MA==&mid=2247489924&idx=1&sn=bbb4a8e7ec9c8c0cfd19357ea5ccab0b

---

全局摘要

今天放出的马斯克3小时深度访谈探讨了人工智能发展的终极边界，重点讨论了将 AI 算力部署至太空以克服地球能源瓶颈的宏大设想。对话涵盖了从星舰的材料选择、人形机器人的规模化制造，到政府效率改革以及人类意识在 AI 时代如何延续等核心议题，强调了物理定律作为唯一准则在工程决策中的主导地位。
...
马斯克对纯软件驱动的 AI 实验室表现出了某种程度的“技术优越感”。他认为，那些生活在软件领域的人即将从硬件那里学到惨痛教训。为了给 xAI 的超级计算机“巨像”（Colossus）供电，他的团队不得不跨越州界解决许可问题，甚至由于供应商的叶片和叶栅铸造能力严重积压，动了自研涡轮机的念头。“限制因素始终存在。如果你想快速行动，就必须亲自解决那个限制因素。”
...
当话题转向 AI 可能带来的生存风险时，马斯克的思考带有一种冷峻的现实主义色彩。他承认，一旦 AI 的智能量超过人类百万倍，试图维持“控制权”是愚蠢的。“我不认为人类能控制比自己聪明得多的事物。我们能做的是确保它拥有正确的价值观。”
...
对话的最后，马斯克将目光投向了更广阔的社会层面。他推动政府效率改革、担忧国债危机的根本动机，是为了给 AI 和机器人的成熟争取最后的时间。“如果没有 AI 和机器人，美国百分之百会破产。我们只需要足够的时间，在破产之前把它们构建出来。”
...
马斯克: Optimia（乐观者复数）。既然我们在定义专有名词，我们也可以定义专有名词的复数形式。所以我们要确定这个专有名词的复数形式，那就是Optimia。

Dwarkesh: 在硬件方面，你有什么想看的吗？你想看到更好的执行器吗？还是你只是希望软件更好？在实现第三代机器人的大规模制造之前，我们还在等什么？

马斯克: 不，我们正朝着那个方向前进。我们正在推进大规模制造。

Dwarkesh: 但是使用当前的……目前的硬件已经足够好，你现在应该，只是想尽快部署尽可能多的机器人。

马斯克: 扩大生产规模非常困难。我说过。但但我认为擎天柱3（Optimus 3）是合适的机器人版本，以便每年生产大约一百万台左右的设备。我认为在达到每年一千万台之前，你会想等到擎天柱4（Optimus 4）。

约翰: 但擎天柱3（Optimus 3）每年可以生产一百万台。

马斯克: 启动制造业非常困难。所以像制造业，其每单位时间的产出总是遵循S型曲线。所以它开始时慢得令人痛苦，然后有一个指数级的增长，接着是线性的，然后，对数型的结果，直到你最终渐近于某个数字。

但在这次初步生产之后，它将是一个被拉长的S型曲线，因为Optimus中如此多的部件是全新的。不存在现有的供应链。正如我所提到，Optimus机器人中的执行器、电子元件、所有东西都是根据物理学基本原理设计的。它不是从目录中挑选的。这些都是定制设计的一切，字面意义上的一切。我不认为有任何东西……这能深入到多深？我猜我们还没有制造定制电容器，也许吧。

但是有……你无法以任何价格从目录中挑选出任何东西。所以这仅仅意味着擎天柱的“埃斯科夫”（Escove），即每单位时间的产出单位，每天能制造多少自主机器人，无论如何，其初始速度将比拥有现有供应链的产品慢。但它会达到一百万。

性能对标与物料清单

Dwarkesh: 当你看到像Unitree这样的中国人形机器人，以大约6千或13千的价格出售类人噪音时。你是否只是希望你的擎天柱的物料清单低于那个价格，以便你能做同样的事情，还是你认为从质量上讲，它们不是同一回事？比如你认为会发生什么，是什么让它能够以单价出售？我们能与之匹敌吗？

马斯克: 擎天柱，我们的擎天柱被赋予了很高的智能，并且具有与人类相同，甚至更高的机电灵巧度。而且它也它是一个相当大的机器人。它，它必须能够，长时间搬运重物，而不会过热或超过饱和器的功率限制。

所以，所以我们 它相当高。而且它具有很高的智能。所以它会比一个不智能的小型机器人更昂贵。但功能更强大。但不会贵很多。比如，随着时间推移，作为优化机器人，成本会非常快地下降。

约翰: 而这第一批十亿个优化者，优化者会是啊。它们将发挥什么最高和最好的用途呢？

马斯克: 我想你会从你可以指望它们做好的一些简单任务开始。

Dwarkesh: 但在家庭或工厂中，比如最好的有用的机器人，一开始会是任何持续性的操作，任何全年无休（24小时/7天）的操作，因为它们可以持续工作。在超级工厂中，目前由人类完成的工作中，第三代机器人能完成多少？我不确定，也许是 10%、20%，也许更多，那是肯定的，我们会使用，我们不会像那样减少我们的人员数量，我们会，我们肯定会。

马斯克: 坦率地说，这可以增加我们的人员数量。但我们会提高我们的产量。所以，每位人类生产的单位，比如特斯拉的总人数会增加，但机器人和汽车的产量将不成比例地增加，每位人类生产的汽车和机器人的数量将急剧增加。

关税政策与电力增长

约翰: 但我们在这里谈论的是中国的制造业，我们也在谈论一些相关的政策，就像你提到的太阳能关税一样。你认为它们是坏主意，因为我们在美国无法扩大太阳能的规模。

马斯克: 只是美国需要扩大电力产出。

约翰: 对，而且如果没有好的能源，它是可以实现的。你只需要想办法获得它。

马斯克: 我想说的如果你负责，如果你制定所有政策，你还会改变什么？所以你们也对太阳能关税进行调整。

马斯克: 我想说任何限制电力发展的因素，都需要得到解决，前提是它对环境没有造成非常大的危害。

约翰: 所以，想必其中也会包含一些许可审批改革之类的内容。

马斯克: 目前正在进行相当多的许可审批改革。大部分的许可审批是基于州级的，所以，但任何改进都好。但这一届政府在清除许可审批方面的，障碍方面做得不错。

我并不是说所有的关税都是坏的，我只是说因为太阳能关税的原因。对对对。有时如果某个国家正在补贴某项产品的产出，那么你就必须征收反补贴关税，以保护国内产业免受另一个国家的补贴冲击。
...
约翰: 我一直在想的一件事对于旨在让美国相对于中国建立租赁的政策目标来说，似乎出口禁令已经产生了相当大的影响。或者说，中国没有生产前沿芯片，而出口禁令确实对那里造成了影响。中国没有生产前沿的涡轮发动机。同样地，在一些冶金领域也存在着相关的出口禁令。你认为是否应该有更多的出口禁令，比如考虑无人机产业以及类似的事情，但这是否是需要考虑的因素呢？

马斯克: 我认为重要的是要认识到，在大多数领域，中国在制造业方面非常先进，只有少数领域不是如此，中国是一个制造大国，达到了一个更高的水平。人们没有意识到，这非常令人印象深刻。

如果以矿石的精炼为例，我估计中国平均的矿石精炼量是世界其他地区总和的两倍。我认为在某些领域，比如你提到的镓的精炼，这用于太阳能电池。我认为它们占了大约 98% 的镓精炼量。所以中国在我想大多数领域实际上是一个非常先进的制造业大国。

约翰: 似乎我们对这种供应链依赖感到不安，但实际上并没有采取任何行动。供应链依赖。依赖于你所说的比如那些（稀土）精炼。所有的稀土材料等等。

马斯克: 稀土——正如它们并不稀有。

约翰: 比如我们在美国确实有稀土开采。

马斯克: 把矿石运送出去，我们把它放在火车上，然后装上船运到中国，那里有另一列火车运到中国的（稀土）精炼厂，他们进行精炼，制成磁铁，装入电机总成，然后把它运回美国。所以，我们真正缺少的是美国的矿石精炼能力。

约翰: 这难道不值得政策干预吗？

马斯克: 我认为在那方面正在做一些事情。但坦率地说，我们需要乐观主义者来建造我们的炼油厂。

人口红利与职业道德的竞争

Dwarkesh: 所以你认为中国的主要优势是熟练劳动力的充裕吗？而这正是擎天柱（Optimus）所解决的问题。但我们也需要……

马斯克: 人口是我们的四倍。

Dwarkesh: 但我们需要……所以，如果认为人类是未来，那么目前，如果由熟练的劳动力制造业决定谁能制造更多的人形机器人，就会有一种担忧。中国有更多的此类工人。它制造了更多的人形机器人。因此，它会先获得优化的未来。

Dwarkesh: 我们拭目以待。它只是保持着那种表达。这似乎是在指出，要达到一百万个“优化器”（optimi），就需要制造出这些“优化器”本应帮助我们达成的目标，你可以相当快地关闭这个递归循环。

约翰: 使用少量的“优化器”。

马斯克: 所以你关闭递归循环是为了帮助机器人制造机器人。然后，如果我们每年能达到几千万，也许达到每年几亿，我认为我们将是迄今为止最具竞争力的国家。我们绝对不能只依靠人类取胜，因为中国的人口是四倍。

没错。坦率地说，美国人已经领先太久了，就像一支长期领先的职业运动队一样，容易变得自满和产生权利感。这就是他们停止赢球的原因，因为他们不再像以前那样努力工作了。所以，坦率地说，我的观察中国人的平均职业道德高于美国，所以不仅仅是人口多四倍，而是人们投入的工作量更高。

所以你可以尝试重新安排人力，但你仍然只有四分之一，假设生产力就是健康水平，我认为这可能并非如此，中国在人均生产力方面可能占有优势。我们做的事情的量将只有中国的一四分之一。所以我们无法在人力方面取胜。出生率长期以来一直很低。所以美国的出生率自大约1971年以来就一直低于更替水平。所以我们有很多人退休，或者死亡的人比，比，比出生的多，我们快要达到国内死亡人数多于出生人数的程度了。

特斯拉的精炼布局：最大且唯一

约翰: 所以我们肯定无法在人力方面取胜，但我们或许可以在机器人方面有所作为。过去你是否想过要制造其他一些由于过于劳动密集型或成本太高而无法实现的东西，现在你可以回来并说，因为我们有了擎天柱（Optimus），我们终于可以做无论什么了。

马斯克: 我认为我们希望在特斯拉做得更多，建造更多的矿石精炼厂。我们刚刚在德克萨斯州科珀斯克里斯蒂完成了锂精炼厂的建设并开始运营，这是没有锂精炼厂的。我们有一个用于阴极的镍精炼厂，它位于奥斯汀。

这些是除中国以外最大型的——这是最大的阴极精炼厂、最大的锂精炼厂、最大的镍和锂精炼厂。阴极团队会说，我们拥有美国最大、实际上也是唯一的一个阴极精炼厂。很多最高级形容词。不仅是最大的，而且是唯一的。所以尽管它是唯一的，它还是相当大的。

但还有其他事情，你可以建造更多的炼油厂，帮助美国提高炼油能力的竞争力。所以，从最优化角度来看，有很多工作要做，而大多数美国人，坦率地说，很少有美国人愿意做这些工作。

约翰: 是炼油工作太脏了，还是怎么回事……

马斯克: 实际上不不，我们没炼油厂没有产生有毒的排放物或任何东西。所以炼油厂的资本，大约在特拉维斯县，离……只有五分钟路程。

约翰: 为什么不用人力来做呢？

马斯克: 不，你可以用，只是人手不够了。 比如，无论你做什么，你的人数在美国和中国加起来只有四分之一。所以如果你让他们做这件事，他们就可以做另一件事。那么，如何建立这种精炼能力呢？你可以用优化器来实现。而且没有多少美国人渴望从事精炼工作。

电力输出：衡量实体经济的替代指标

Dwarkesh: 如果你计划进行精炼，那会怎样？企业价值投资（BID）在产量上正接近特斯拉的产量或销量。你认为会发生什么？随着中国在电动汽车技能方面的产能提升，这会对全球市场产生什么影响？

马斯克: 中国在制造业方面极具竞争力。所以我认为将会有大量的中国汽车和其他基本上所有制成品涌入市场。

就像我说的，中国现在的提炼能力可能只是世界其他地区总和的两倍。所以，如果你去，如果你深入到像第四级和第五级的供应链环节，比如在基础层面，我们有能源，然后是采矿和提炼。那些基础层面，正如我所说，粗略估计，中国的提炼量是世界其他地区的总和的两倍。

因此，任何给定产品都将包含中国的成分，因为中国的提炼工作量是世界其他地区总和的两倍。然后他们会一路生产到最终产品，也就是汽车。中国是一个强大的力量。我认为今年中国的（发电量）将超过美国的3倍。电力产出。电力产出是衡量经济的一个合理替代指标。

所以，为了运转工厂和所有事物，你需要电力。因此，电力是衡量实体经济的一个良好替代指标。所以，如果中国，如果中国的电力产出超过美国的3倍，这意味着它的工业产能。这是一个粗略的近似值。

Dwarkesh: 是美国的3倍，那将是美国的3倍。揣摩您的言外之意，听起来您是说，在未来几年内，如果不存在某种类人递归的奇迹，在整个制造业、能源、原材料链方面，中国将占据主导地位，无论是在人工智能、电动汽车制造，还是人形机器人制造方面。

马斯克: 在美国缺乏突破性创新、中国将彻底占据主导地位。有趣的机器人技术是主要的突破性创新。如果你想在太空中扩大人工智能的规模，那么你基本上需要人形机器人，你需要真实世界的人工智能，你需要每年向轨道输送一百万吨物质。

比如说，如果我们让月球上的质量驱动器运行起来，这是我最喜欢的事情，我认为我们将解决所有的问题。所以我称之为胜利。我称之为胜利。

科幻成真：月亮是一个严酷的痛苦之源

约翰: 你终于可以感到满足了。你做成了一些事。你在月球上有质量驱动器了。

马斯克: 没错。我只是想在我们的版本中看到那个东西。那是出自某个科幻作品还是从哪里...

实际上，有一本高地（Highland）的书。《月亮是一个严酷的痛苦之源》（Moon is a Harsh Mistress）。

约翰: 但是这略有不同。那是引力弹弓或者……

马斯克: 不，他们有一个质量投射器。 但他们用那个来攻击地球，所以也许这不是最棒的……他们用那个来……

他们宣布了独立。地球政府不同意，他们喜欢这些事物，直到地球政府同意为止。

约翰: 那本书真逗。我觉得那本书比他那本每个人都在读的《陌生人或奇异之地》好多了。格罗克（Grok）来自《陌生人在奇异之地》（Stranger in a Strange Land）。但我更喜欢……

马斯克: 《绞杀地》（Stranglerlandland）的前三分之二是然后第三部分变得非常奇怪。但其中仍然有一些好的概念。

招聘哲学：非凡能力的证据

约翰: 我们大量讨论的一件事是您管理人员的体系。比如，您面试了SpaceX最初的几千名员工，我也面试过许多其他公司的员工。什么是……显然，它无法规模化。

约翰: 但什么无法规模化呢？

约翰: 当然。我知道，但您到底在寻找什么？字面上说，一天之内没有足够的时间，这是不可能的。但您在寻找的是什么，是那些善于面试和招聘人员的人所寻找的特质？那个“天才配额”是什么？

马斯克: 到目前为止，我认为我已经……我在评估技术人才方面可能拥有更多训练数据，尤其但我猜是所有类型的人才，但技术人才尤为突出。鉴于我进行了大量的技术面试，并看到了结果。所以我的训练集是庞大的，并且范围非常广泛。

通常我要求的是关于非凡能力的证据的要点列表。所以，它，但它这些事物可能相当离奇。它不需要在特定领域内。特定领域内，而是关于非凡能力的证据。所以，如果有人能引用一件事，但他们说了三件让你觉得“哇，哇”的事情，那就是一个好兆头。

Dwarkesh: 但为什么要由你来决定这一点呢？

马斯克:  所有公司加起来的总人数，200,000人。

约翰: 对。但在早期，在那些面试中，有什么是你认为不能授权的事情？

马斯克: 我想我需要建立我的训练数据集。这不是大概1,000人的事。我会犯错。但然后我能看到我原本认为会表现出色的人，但他们没有。然后为什么他们没有表现出色呢？在未来，我该如何通过强化学习（RL）来提高我在面试他人时的成功率呢？所以我的成功率仍然不是完美的，但非常高。

相信互动而非纸面简历

Dwarkesh: 有没有一些令人惊讶的，人们最终没有成功的原因？令人惊讶的原因吗？比如，他们不了解技术领域，等等等等。但你现在有了很长的后续问题，比如，我对这个人感到非常兴奋。结果没成功。好奇为什么会发生这种情况？

马斯克: 所以，通常当我和别人说，或者对我自己说，我猜是抱有期望地说，不要只看简历，要相信你的互动。所以如果简历看起来非常令人印象深刻，让你觉得，哇，简历看起来不错。但如果20分钟后的谈话那个谈话并不精彩，你应该相信谈话本身，而不是那篇论文。

高管任期与“精灵尘埃”效应

约翰: 我感觉你的方法的一部分几年前媒体上有一个关于特斯拉高管人才像旋转门一样的梗，因为事实上，我认为当你审视它时，特斯拉在过去几年中拥有一批非常稳定且内部晋升的高管团队，而在太空探索技术公司（SpaceX），你有马克·詹科萨和史蒂夫·戴维斯这样的人，史蒂夫·戴维斯现在在无聊公司（The Boring Company）任职。不不，还有比尔·莱利和这样的人，感觉上奏效的部分是拥有非常能干的技术副手。所有这些人有什么共同点？

马斯克: 我想说的就高级团队而言，到目前为止，平均任期可能是10年或12年。这相当长了。任期相当长。但是特斯拉经历过极快的增长基础的时期。所以，事情只是在某种程度上被加速了。而且当一家公司经历不同数量级的规模变化时，能够帮助管理一个50人公司与一个500人公司，再与一个5000人公司或50000人公司的人员配置是不同的。

所以，如果一家公司增长非常迅速，高管职位的更替速度通常也会与增长的迅速程度成正比。然后，特斯拉面临着另一个挑战，就是当特斯拉非常成功的时候，我们会被无情地挖人，真的是无情地。

比如，当苹果公司有他们的电动汽车项目时，他们会向特斯拉进行地毯式轰炸式的招聘。工程师们只是拔掉了他们的电话线。我正在努力工作。如果我再接到一个来自苹果招聘人员的电话。但他们甚至不需要面试就直接给出比特斯拉高两倍的薪酬。所以我们遇到了一点特斯拉的“精灵尘埃”效应，就是好如果我们雇佣一个特斯拉的高管，突然间，一切都会成功。

我也曾落入这种“精灵尘埃”的陷阱，就是好我们雇佣一个来自谷歌或苹果的人，他们会立即成功，但事实并非如此。人就是人。这不是什么神奇的“精灵尘埃”。所以当我们遇到“仙尘”问题时，我们会被无情地招募。而且特斯拉，尤其是工程部门主要在硅谷，人们更容易，就像他们不必改变自己的生活太多一样。他们可以做到，通勤还是一样的。

招聘的核心特质：驱动力与善良的心

约翰: 那只在奥斯汀就有帮助了。

马斯克: 奥斯汀，还是有帮助的。特斯拉的大部分工程部门仍然在加利福尼亚。所以，对于让工程师搬迁，我称之为“重要伴侣问题”。

约翰: 所以其他人有工作。

马斯克: 完全正确。所以对于星港基地（Starbase）来说，那尤其困难。

Dwarkesh: 因为在德克萨斯州格兰伯里找到一份非太空探索技术公司（SpaceX）的工作的几率，这相当困难。这有点像一个技术修道院。远程工作，而且大多数是男性。

但话说回来，如果你去看看那些在特斯拉、在太空探索技术公司以及类似地方，在技术能力方面非常有效率的人，那会是一个很大的进步。如果你回溯到这些人。你认为他们有什么共同之处，除了，比如，他们只是在火箭技术或技术基础知识方面非常敏锐吗？还是你认为这与组织结构有关，与他们与你共事的能力有关？这是他们能够保持灵活，但又不过度灵活的能力吗？

约翰: 什么样的人是你理想的切磋伙伴？

马斯克: 我不会想到“切磋伙伴”这个概念。如果有人能把事情办成，我就喜欢他们，如果他们做不成，那就这样，这很直接。这并不是某种特殊的、个人的东西。如果有人做得很好，我就是他们的忠实拥护者；如果他们做不好，我就不是。但这并不是要符合我个人的特殊偏好。我当然会努力不让它符合我个人的特殊偏好。

所以，但总的来说，我认为招聘看重才能、驱动力和可信赖度是个好主意。而且我认为善良的心很重要。我会在这一点上等待。所以，比如，他们是好人吗，值得信赖吗，聪明吗，有才能吗，而且勤奋吗？如果是这样，你就可以增加领域知识了。但那些基本的特质、那些基本属性是无法改变的。所以，在特斯拉和SpaceX的大多数人并非来自航空航天业或传统行业。

纳米管理与瓶颈限制

Dwarkesh: 随着您的公司从100人、1000人发展到10000人，这对您的管理风格带来了哪些最大的改变？您以事无巨细的微观管理而闻名，深入到事情的细节中。

Dwarkesh: 纳米管理，请说。

Dwarkesh: 请说明人员管理，幻影管理，所以您是说我们要一直深入到普朗克常数，我们要一直深入到海森堡，突然变得更小，那么您如何，您是否仍然能够尽可能多地深入细节，如果您的公司规模更小，它们是否会更成功？您如何看待这个问题？

马斯克: 因为我一天的时间是有限的，随着事物的增长和活动范围的扩大，我的时间必然会被稀释。所以，我不可能真正地进行微观管理，因为那意味着我每天需要有数千小时的时间。对事物进行微观管理在逻辑上是不可能的。

所以现在，有时候我会深入到一个具体的问题中，因为那个具体问题是公司进步的限制因素。但是深入研究这个非常详细的项目的原因，是因为它是限制因素。这并不是在随意钻研微不足道的小事。正如我所说，显然，从时间角度来看，你不可能在不重要的细枝末节上随意钻研，否则必然会导致失败。但有时，微小的事情是决定胜利的关键。

星舰的钢铁之路：出于绝望的抉择

约翰: 著名的您将星舰的设计从复合材料改为用钢材。这是您做出的决定。那并不是说，人们四处走动。他们我们发现自己有了更好的东西。那是您在顶住某些阻力的情况下鼓励人们做的。您能告诉我们您是如何做出那个决定，即全部改用钢材，而不是复合材料的吗？

马斯克: 我得说，这是出于绝望。原来，我们打算用碳纤维制造星舰，而碳纤维相当昂贵。当你进行批量生产时，任何给定材料的成本通常都会开始趋于平稳。碳纤维的问题在于材料成本仍然非常高。所以，成本大约是50倍，特别是如果你采用能承受低温液氧的高强度特种碳纤维时。

这引用，成本大约是钢的50倍。而且理论上至少会更轻。人们通常认为钢很重，而碳纤维很轻。对于室温应用，比如一级方程式赛车的室温或多或少类似的应用，静态误差结构或任何类型的误差结构，你可能会发现使用碳纤维效果更好。

现在的问题我们试图用碳纤维制造这个巨大的火箭，但进展极其缓慢。

约翰: 它首先被选中就因为它轻。比如乍一看，大多数人会认为制造轻质物体的选择是碳纤维。

马斯克: 现在的问题当你用碳纤维制造非常巨大的东西，然后你试图让碳纤维有效固化时，意思是不能室温固化。因为，比如，你有时有大约50层碳纤维。而碳纤维实际上是碳线和胶水的组合。为了实现高强度，你需要一个高压釜。所以它本质上是一个高压烤箱。如果你有一个巨大的东西，这个专辑必须比洛克兰（Rockland，可能指代某个尺寸或标准）的要大。所以我们正试图制造一个比有史以来任何高压釜都要大的高压釜（clave，此处可能是指代高压釜或某种装置），或者进行室温固化，这需要很长时间并且存在问题。但最终的问题我们在碳纤维方面进展非常缓慢。

低温材料科学：为什么钢材更轻？

Dwarkesh: 我认为更深层次的问题为什么必须由你来做那个决定。你的团队里有很多工程师。团队怎么就没有得出使用钢材的结论呢？完全正确。这是理解贵公司比较优势的更广泛问题的一部分。

马斯克: 所以因为我们在碳纤维方面进展非常缓慢，我想，我们得尝试点别的了。现在，对于猎鹰系列，主要的机身由铝锂合金制成，这是一种非常非常好的强度重量比材料。事实上，就其应用而言，它的强度重量比与碳纤维相当，甚至可能更好。

但是铝锂合金在焊接方面非常难以操作。你必须做一种叫做搅拌摩擦焊的技术，你在不进入液态基体的情况下连接金属。所以你能做到这一点，真是太神奇了。但是使用这种特定的焊接方式，你可以做到。但比如说你想对铝锂合金进行修改或附加一些东西，那就非常困难了。你现在必须使用带密封件的机械连接。你不能把它焊上去。

所以我想避免在星舰上使用铝锂合金。以及用于主要结构的锂。对于火箭来说，你真正想做的是最大化推进剂占火箭的百分比，同时最小化质量。显然，它喜欢……我们进展非常缓慢，正如我所说，照这个速度，我们永远也到不了火星。所以我们最好想点别的办法。

我不想使用铝锂合金，因为在规模化生产中，尤其是进行摩擦搅拌焊时存在困难。直径3.6米时已经很困难了，更不用说9米或更大的直径了。然后我说，那钢怎么样？

所以现在，我找到了一个线索，因为早期的一些美国火箭曾使用过非常薄的钢材。宇宙神火箭（Atlas Rockets）使用了一个钢制气球式油箱。所以这并非说钢从未被使用过。它实际上已经被使用过了。

当你观察不锈钢的材料特性时，特别是如果它是全硬化、经应变硬化的不锈钢，在低温下，其强度重量比实际上与碳纤维相似。因此，如果你在室温下观察材料特性，你会发现钢的重量大约是两倍。但如果你在低温下观察特定牌号的全硬化不锈钢的材料特性，你实际上会得到与碳纤维相似的强度重量比。

在星舰（Starship）的情况下，燃料和氧化剂都是低温的。所以对于“猎鹰9号”（Falcon 9），燃料是火箭推进级煤油，基本上是一种非常纯净的喷气燃料形式，但它的温度大致是室温，尽管我们确实会将其稍微冷却一下，我们会稍微冷却它。非常棒。我们会冷却它，但它不是低温的。事实上，如果我们让它变成低温的，它只会变成蜡状。

所以，但对于星舰来说，它是液态甲烷和液氧。它们在相似的温度下是液态的。所以基本上，几乎整个主要结构都是低温的。所以接着你就有了经过形变硬化的300系列不锈钢。因为它处于接近完全是低温的状态，实际上它的重量强度与碳纤维相似，但成本比普通材料低50倍，而且非常容易加工。

你可以在户外焊接不锈钢，你可以抽着雪茄焊接不锈钢，它就像是非常有韧性的，你可以很容易地修改它，如果你想附加任何东西，你只需直接焊接上去，所以它非常容易加工，成本非常低，就像我说的，在低温下，重量强度与碳纤维相似。

然后当你考虑到这一点时，我们不需要，我们不需要，我们的隔热罩质量大大减少了，因为钢的熔点远高于铝的熔点。大约是铝熔点的两倍。所以你可以让火箭运行得更热一些？

所以特别是对于那艘像燃烧的流星一样归来的飞船。它可以大大减轻隔热罩的质量。所以你可以将隔热罩迎风部分的质量减少，也许减半。而且迎风面的那一侧你不需要任何隔热罩。

所以最终结果实际上钢制火箭比碳纤维火箭轻，因为碳纤维火箭中的树脂开始熔化。所以基本上，碳纤维和铝的工作温度能力差不多，而钢铁可以在两倍的温度下工作。这些都是非常粗略的近似值。人们会，我不会去写火箭的性能页的。我只是说，人们会说，他说的是两倍。实际上，它实际上是0.8。闭嘴，混蛋们。这才是主要评论会针对的。该死。关键在于，回想起来，我们一开始就应该从钢材入手。

星舰复杂性与可重复使用性挑战

约翰: 不使用钢材是愚蠢的。为了复盘一下，我听到的信息相对于碳纤维这种更成熟的早期路径（早期美国火箭除外），钢材是一条风险更高或经验更少的道路，而碳纤维虽然更糟糕，但却是更成熟的路径。所以你需要成为那个推动者，推动“我们要走这条风险更高的道路，然后解决所有问题”。所以你某种程度上是在对抗一种保守主义。

马斯克: 这就是我一开始说问题在于我们进展不够快的原因。我们甚至难以制造出不带褶皱的碳纤维小筒段。因为在这个大尺寸下，你需要很多层的碳纤维。你必须固化它，而且必须以一种不产生任何褶皱或缺陷的方式进行固化。碳纤维的弹性远不如钢材。它的韧性较低。所以像不锈钢会伸展和弯曲，而柱状纤维倾向于碎裂。因此，应力应变曲线下的顶部区域（即屈服强度以上的部分），所以你通常需要用钢材做得更好一些。确切地说，是不锈钢。

约翰: 他们关于星舰的一个问题。所以两年前我和萨姆·泰勒参观了星港，那真是太棒了。从很多方面来看，那都非常酷。我注意到的一件事人们非常以事物的简洁性为荣。每个人都想告诉你星舰只是一个巨大的苏打水罐，而且，我们在招聘焊工，如果你能在任何工业项目中进行焊接，你就可以在这里焊接，但他们对这种简洁性感到非常自豪。而这，恰恰相反，星舰是一个非常复杂的火箭。所以这就是我的意思。事情是更简单了还是更复杂了？

马斯克: 我想他们可能只是想说的你不必在火箭行业有先前的经验才能在萨沙（Sasha）项目上工作。某人只需要聪明、努力工作并且值得信赖，他们就可以在火箭公司工作。他们不需要有火箭工作的经验。星舰（Starship）是人类有史以来制造的最复杂的机器，而且遥遥领先。

马斯克: 在哪个方面？

马斯克: 真的，任何方面。我会说没有比它更复杂的机器了。我会说几乎任何一个项目。我想到的都比这个容易。这就是为什么没有人制造出可快速重复使用的（火箭）。没有人曾经制造出完全可重复使用的火箭。这是一个非常困难的问题。以前有很多聪明人尝试过，非常聪明的人，动用了巨大的资源，但他们都失败了。而我们还没有成功。猎鹰（火箭）是部分可重复使用的，但上面级（或称助推器上级）不是。

星舰（Starship）3型，我认为这个设计可以完全重复使用。而这种完全可重复使用性将使我们能够成为一个多行星文明。

瓶颈因素与隔热罩难题

约翰: 你能谈谈那些圆圈吗？

马斯克: 我不会，我再说一遍，我可以，任何技术问题，即使像水龙带云（或类似概念）这样的问题，遵循这个（方法）会更容易。

约翰: 我们在瓶颈问题上花费了大量时间。你能说一下目前星舰的瓶颈在哪里吗？

马斯克: 即使从高层面上来说，我指的是努力让它不爆炸，这是一个老生常谈的问题，它真的非常容易爆炸，所有那些易燃物，我们已经有两次助推器在测试中爆炸了，然后有一个把整个测试设施都炸毁了。

所以只需要犯一个错误，而且我说的是星舰内部所蕴含的能量是惊人的。这是否就是它比猎鹰火箭更难的地方？是因为它的能量更大，它使用了大量的最新技术，它在不断突破性能极限。猛禽3（Raptor 3）发动机是一款非常非常先进的发动机，是迄今为止人类制造的最好的火箭发动机，但它极度容易爆炸。

让我们把事情放在一个视角来看，在起飞时，这枚火箭产生的功率超过了100吉瓦，这相当于美国电力的20%。这是一个很好的比较。

马斯克: 在不爆炸的情况下。

马斯克: 有时候。有时候会。但有时候，所以我当时就在想，它怎么才能不爆炸呢？有成千上万种方式会导致它爆炸，却只有一种方式能避免爆炸。所以我们的目标它不仅是不爆炸，而且是能可靠地、每天飞行，像每小时一次那样频繁。

很明显，它会经常解体。维持这种发射节奏非常困难。然后，我想说，星舰目前最大的遗留问题是什么？是让隔热罩可重复使用，因为到目前为止还没有人制造出可重复使用的轨道级隔热罩。所以隔热罩在上升阶段不能震掉太多瓦片。然后它会返回。同时也不能丢失太多瓦片或使主机身过热。

这很难，因为它本质上是一种消耗品？但你汽车里的刹车片也是消耗品，但它可以使用很长时间。说得有理。所以它只需要使用很长时间。我们把飞船带回来了，并在海洋上进行了软着陆。我做过几次了。但它丢失了很多隔热瓦，不经过大量工作就无法重复使用。所以即使它确实着陆了，确实实现了软着陆，但如果没有大量的工作，它也是无法重复使用的。所以从这个意义上讲，它并不是真正可重复使用的。

仍然存在的最主要问题是完全可重复使用的隔热罩。所以，如果你想能够着陆、加注推进剂并再次飞行，就不能对所有东西进行那种费力的检查，检查四万块隔热瓦。

驱动紧迫感：气体膨胀定律与物理限制

Dwarkesh: 我很好奇你是如何驱动的，比如，当我阅读你的传记时，感觉你就是能够驱动那种紧迫感，并驱动那种“这是能够实现规模化的事情”的感觉。我很想知道你为什么认为像SpaceX和特斯拉这样的其他组织现在已经成为大公司了，但你仍然能够保持那种文化，其他公司哪里出了问题以至于无法做到这一点？

Dwarkesh: 但就像今天你说你有一堆关于SpaceX的会议。你在那里具体是做什么，是什么让你保持着那种紧迫感？是那种增加紧迫感的东西。

马斯克: 我想紧迫感将来自于我领导公司的方式。所以我的紧迫感，我有一种狂热的紧迫感。所以那种狂热的紧迫感会投射出去。到公司的其他部门。

Dwarkesh: 是因为后果吗，他们如果，埃隆有一个疯狂的截止日期，但如果我做不到，我知道对我意味着什么。仅仅是因为你能够识别瓶颈并消除它们，这样人们才能快速行动吗？比如，你如何看待你的公司为何能够快速发展？

马斯克: 我一直在解决限制因素。所以，就截止日期而言，我通常会尽量设定一个我认为至少是第50百分位数的截止日期，所以它不是一个不可能的截止日期，但它是我能想到的最激进的、有50%概率可以实现的截止日期，这意味着它有一半时间会延迟。

而且无论如何，就像气体膨胀定律适用于时间表一样，无论你给出的时间表是什么，比如如果你说我们要在五年内做某件事，对我来说就像是无限的时间，它会扩展到完全可用的时间表，并且会花五年时间。存在一个物理限制。物理定律会限制你做某些事情的速度。比如扩大制造规模，存在一个移动原子和扩大制造的速度限制。

这就是为什么你不能瞬间制造出，一百万件东西，一年一百万件或者之类的事情。你必须设计制造产线。你必须让它运转起来。你必须驾驭生产的S曲线。所以，我想，我能说些什么对人们真正有帮助的呢？我认为通常而言，一种狂热的紧迫感是非常重要的事情。而且你想要有一个积极进取的日程安排。然后你想弄清楚任何时候的限制因素是什么，并帮助团队解决这个限制因素。

越级会议与工程评审

约翰: 你能否谈谈，星链（Starlink）是酝酿了多年才逐步实现的。我们在公司一开始就谈论过它了。然后你在雷德蒙德（Redmond）建立了一个团队，但后来你决定这个团队根本无法满足我们的要求。但话说回来，你是如何……这事情已经持续了几年了。缓慢地进行，所以为什么会这样？你为什么没有早点采取行动？你为什么选择那个时候采取行动？那个时刻为什么是你认为应该行动的最佳时机？

马斯克: 我每周都有非常详细的工程评审，这可能是一个非常不寻常的细致程度，我不知道有谁在经营一家公司，或者至少是制造型公司，会深入到我这种程度的细节中去。所以并不是说我对实际发生的事情没有一个相当好的了解，因为我们是详尽地讨论了这些问题的。

我非常信奉“越级会议”，即让员工而不是直接向我汇报的人来发言，让向他们汇报的每个人都在技术评审中发表意见。而且不能提前准备，否则你会看到，（他们）眼神涣散。正如我今天所说。

Dwarkesh: 完全正确。你真是太“Z世代”了。你如何防止事先准备？你就是随机打电话给他们？

马斯克: 不，只需在房间里走一圈，每个人都提供最新情况。所以，要记住这些信息量很大，因为你比如，如果你每周开会两次，你就能得到那个人所说内容的快照，然后你可以描绘出进展点，你可以大致在脑海中将这些点描绘在曲线上，然后说，我们是否在收敛到一个解决方案？或者，比如，只有当我认为成功不在可能的结果集合中时，我才会采取激进行动。

所以当我说，当我最终得出结论，除非采取激进行动，否则我们没有成功的机会时，那么我必须采取激进行动。所以我在2018年得出了需要采取激进行动并解决问题的结论。

管理多家公司的调度逻辑

Dwarkesh: 有多少，你有许多许多公司，在每家公司中，听起来你都会对相关的瓶颈进行这种深入的工程理解，这样你才能与人们进行这些审查。你已经成功地将其扩展到五家、六家、七家公司。在这些公司中，你内部有许多不同的微型公司。这里的最大值由什么决定？你们能有大约80家公司吗？

Dwarkesh: 80家？不能。但你们已经有很多了。这已经很了不起了。为什么是现在的这个数量？没错。

马斯克: 我知道。所以我们几乎连一家公司都维持不住。没错。这取决于情况。所以我实际上没有和陷入冲突的公司进行例会。所以，这家处于竞争中的公司可以说是在平稳前行。看，基本上，如果某件事进展顺利且取得良好进展，那么我花时间在上面就毫无意义。

因此，我实际上是根据瓶颈因素来分配时间的。或者说问题出在哪里，哪些地方存在问题，或者我们正在遭遇哪些……比如什么在阻碍我集中精力（我担心把“瓶颈因素”这个词说太多次了）……所以基本上，如果某件事进展顺利，他们就很少见到我；但如果某件事进展不顺，他们就会见到我很多次。或者不一定是进展不顺。

就像如果某件事是瓶颈因素一样。它就是瓶颈因素，没错。它不一定是非常糟糕，但它是我们需要让它加速的事情，以便。

约翰: 所以，如果SpaceX或特斯拉的某件事是瓶颈因素，你会每周甚至每天与负责该工作的工程师交谈吗？这具体是如何运作的？

马斯克: 大多数瓶颈因素的跟进是每周一次，有些事情是每周两次。所以AI-5芯片评审是每周两次。所以是每周二和周六进行芯片评审。

约翰: 它是开放式的吗，持续多久？

马斯克: 从技术上讲但通常是两到三个小时。有时更短。这取决于我们需要处理多少信息。

约翰: 那是另一回事。我只是想梳理出这里的不同之处，因为结果似乎相当不同。因此，我认为注意哪些输入有所不同很有意思。而且感觉公司世界，第一，就像你说的，首席执行官亲自进行工程评审的情况并非总是发生，尽管事实上，这就是公司正在做的事情。但时间通常被切分得很细碎，比如半小时的会议，甚至是15分钟的会议。而且你似乎更倾向于进行开放式的、直到我们弄明白为止的那种讨论。

马斯克: 有时候是这样，但大多数会议会使得团队基本上能按时结束。所以，今天的星舰（Starship）工程师面试时间稍微长了一些，因为有更多的话题需要讨论。他们正试图弄清楚如何将每年超过两百万吨的载荷送入轨道，这极具挑战性。

政府效率、国债与 AI 的拯救作用

Dwarkesh: 我能回答一个问题吗？所以你说到擎天柱（Optimus）和人工智能将会在几年内导致双倍的增长率？像经济一样？

马斯克: 我想那是对的。

Dwarkesh: 如果经济会增长这么多，政府效率部的削减是为了什么？

马斯克: 我认为浪费和欺诈都不是好事，我实际上相当担心，我想，在没有人工智能和机器人的情况下，我们实际上会彻底完蛋，因为国债正在疯狂堆积。现在，我们的利息支付，国债的利息支付已经超过了军事预算，那可是万亿美元。所以光是利息支付就超过了一万亿美元，当时我就觉得，我对那相当担心。

也许如果我花点时间，我们就能减缓美国的破产速度。并给我们足够的时间让人工智能和机器人来帮助解决国债问题。这是唯一能解决国债问题的方法。比如，如果没有人工智能和机器人，我们这个国家百分之百会破产，会作为一个国家而失败。没有其他任何东西可以解决国债问题。所以我们想...我们只需要足够的时间来构建人工智能和机器人。在那之前不至于破产。

Dwarkesh: 我好奇的当政府效率部门开始运作时，你拥有了推行改革的巨大能力。

Dwarkesh: 也没那么巨大。当然。但完全同意你的观点，即人工智能和机器人技术推动产品改进、推动国内生产总值增长非常重要。但为什么不直接着手处理你指出的那些问题，比如某些零部件的关税，或者更确切地说，是许可问题呢？

Dwarkesh: 我就像总统一样。

马斯克: 而且削减那些显而易见的浪费和欺诈，比如荒谬的浪费和欺诈，是非常困难的。我发现，即使是削减政府中非常明显的浪费和欺诈，也是极其困难的。

因为政府的运作方式往往是“谁在抱怨”，比如如果你停止向欺诈者付款，他们会立即想出听起来最令人同情的理由来要求继续付款。他们不会说，请让欺诈继续下去。他们会说，他们会说，你们正在杀死小熊猫。而我们却说，与此同时，根本没有小熊猫在死去。他们只是在编造。这些势力有能力编造出极其令人信服、令人心碎的故事，这些故事是虚假的，但听起来仍然令人同情。发生的就是这种情况。

所以我就觉得也许我应该更清楚一些。然后我想，等等，让我们试着削减政府中一部分的浪费和不当之处。也许不应该2000万在社会保障体系中被认定为在世但实际上已经死亡的人。而在115岁以上，美国最年长的人是114岁。所以可以说，如果有人115岁并且在社保数据库中被标记为在世，那么肯定有什么问题，要么是输入错误。所以，有人应该打电话给他们说，我们好像把您的生日搞错了，或者我们需要将您标记为已故。两者之一。

马斯克: 这是个很吓人的电话。

马斯克: 这似乎是合情合理的。如果，比如说，他们的生日是在未来。而且他们一笔小企业管理局的贷款，而他们的生日是2165年。那么我们再次面临的要么是输入错误，要么就是欺诈。所以我们说我们似乎把您的出生世纪搞错了。

马斯克: 或者是一个伟大的电影剧本。

马斯克: 这就是我记起荒谬欺诈的时候。这就是我为什么关注荒谬欺诈的原因。

联邦支付系统的漏洞与审计

马斯克: 那些人拿到报销款了吗？一些人拿到了社会保障金。但主要的欺诈途径是标记。在社会保障体系中将某人标记为在世，然后利用所有其他政府支付系统来进行欺诈，因为那些其他政府支付系统会做什么呢？它们会简单地向社会保障数据库发送一个在世核对。这是一次间接射击。

Dwarkesh: 你估计通过这种机制产生的欺诈总金额是多少？

马斯克: 我的猜测顺便说一句，政府问责局之前做过这些估算。我不是唯一一个没有从中学到教训的人。事实上，我认为他们，政府问责局确实对拜登政府期间的欺诈行为进行了粗略估算分析，计算出的金额大约是五千亿美元。所以不要听信我的一面之词。参考拜登政府期间发布的一份报告。这怎么样？

马斯克: 通过这个社会保障机制吗？

马斯克: 这只是众多途径中的一个。重要的是要认识到，政府在阻止欺诈方面效率低下，因为它不不像一家公司那样，公司有动力去阻止欺诈，因为这会影响公司的收益。但政府只他们只是印更多的钱。

所以这不是说你需要，你需要关心和能力，而这些在联邦层面是稀缺的。我很抱歉，当你去机动车管理局（DMV）时，你会觉得哇，这是一个能力高超的堡垒吗？现在想象一下，情况比机动车管理局更糟，因为它是一个可以印钱的机动车管理局。

至少州一级的机动车管理局需要，各州或多或少需要遵守预算，否则会破产，但联邦政府只是印更多的钱。

Dwarkesh: 那么，如果存在五千亿的欺诈行为，为什么不能把这些都削减掉呢？

马斯克: 因为一旦我们这么做了，我们实际上，你看，你真的需要退后一步，并重新校准你对能力的期望。因为你生活在一个你需要勉强度日的世界里，比如，你需要支付账单，你需要，你知道……购买麦克风。

马斯克: 完全正确。

马斯克: 所以你，如果你没有……并不是说存在一个巨大、大多冷漠的怪物官僚机构。甚至都不是……还有一堆不准确的计算机正在发送付款。

比如，政府效率部门团队做的一件事，听起来很简单，但可能会每年节省，比如说，1000亿，也许是2000亿，就是简单地要求主国库计算机（它被称为PAMs，大概是付款账户主控系统之类的东西，每年有5万亿美元的资金流动）发出的任何付款，都必须附带付款拨款代码。

使其成为强制性而非选择性的，并且要求在注释字段中填写任何信息。因为你看，你必须重新校准事情有多么愚蠢，付款在没有拨款代码的情况下被发送出去，没有回溯到任何国会拨款，也没有任何解释。这就是为什么战争部，即以前的国防部，无法通过审计，因为信息根本就不存在。重新校准你的预期。

欺诈的比例：对比 PayPal 的治理

Dwarkesh: 我想弄清楚这个五千亿的数字是怎么回事，因为2024年有一份监察长（IG）报告。怎么会，你肯定会觉得，为什么会这么低？

Dwarkesh: 也许吧，但我们发现，在七年多的时间里，社会保障欺诈的估计金额约为700亿美元，也就是每年大约100亿美元。所以我会很好奇，另外那49亿（美元）是从哪里来的。

马斯克: 联邦政府每年的开支是7.5万亿美元。你认为其中的多少比例是称职的？那里的可自由支配支出大约是15%。但这不重要。福特（指联邦政府支出）的大部分是非可自由支配的。这基本上是欺诈性的医疗保险、医疗补助、社会保障，残疾福利。政府有数不清的款项。而其中一些款项实际上是它们对各州的区块转移拨款。因此，在很多情况下，联邦政府甚至没有信息来了解是否存在欺诈。

让我们像一个缩减版或伪装版。政府是完美的，没有任何欺诈。你对此的概率估计是多少？

Dwarkesh: 我的意思是……

马斯克: 零。那么，你会说政府的欺诈和浪费达到了90%吗？那也将是相当慷慨的。但如果只有90%，这意味着每年有7500亿美元的浪费和欺诈。而且它不是90%。它的有效性不是90%。

Dwarkesh: 这看起来是政府欺诈规模的基本原理中一个奇怪的比率。你认为有多少？然后，总之，我们不知道如何实时做到这一点，但我很想知道，比如，你对反欺诈方面了解很多。

马斯克: 人们一直在试图进行欺诈。

约翰: 但正如你所说，这有点我们确实已经把它打磨得很好了，但这涉及到一个截然不同的问题空间，因为你在这里处理的欺诈向量比我们所处理的要异构得多。

马斯克: 但那就是尝试，你很有信心，并且你很努力。你的能力很高，也很关心，但欺诈仍然不为零。现在想象一下，如果规模要大得多，能力和关怀都要少得多。回想当年做贝宝（PayPal）的时候，我们努力将欺诈控制在支付额的1%左右。那非常困难。要将欺诈率仅仅降低到1%，就需要付出巨大的能力和关怀。现在想象一个组织，那里的关怀和能力都少得多。那肯定会远超1%。

政治部落化与收购 Twitter 的初衷

约翰: 回顾一下政治和做事情，你现在感觉如何？从外部看，有两件事影响非常大，一是“美国优先”（America Pack），二是收购了推特（Twitter）。但似乎也伴随着很多痛苦，所以你对整个经历的评价如何？

马斯克: 我认为那些事情是必须做的，以最大化未来美好的概率。所以政治通常是非常部落化的，而且是极其部落化的。人们通常在政治问题上会失去客观性。他们通常很难看到对方的好处，或者看到自己阵营的坏处。情况通常就是这样。

我想，这可能是我最惊讶的事情之一，如果你属于某一派系，你通常根本无法与之讲道理，他们仅仅相信自己派系所做的一切都是而另一个政治派系所做的一切都是坏的。让他们相信相反的观点几乎是不可能的。所以，但我认为，总的来说，那些行动，比如收购推特，比如让某人当选，尽管这让很多人感到愤怒，但我认为这些行动对文明是有益的。

Dwarkesh: 这如何能助推你所期待的未来呢？

马斯克: 美国需要继续存在，美国需要足够强大，以便能持续足够长的时间，将生命延续到其他地方。并使人工智能和机器人技术发展到我们可以确保未来是美好的那个地步。比如，另一方面，如果我们衰落到，比如说，共产主义或某种国家极度压迫的境地，那将意味着我们可能无法实现多行星化。而且国家可能会，阻碍我们在人工智能和机器人技术方面的进步。

政府：最大的暴力垄断公司

Dwarkesh: 您对擎天柱、全球监管组织（GROC）等将被政府利用，并且不仅是您个人的产品，而是任何收入最大化公司的产品，随着时间的推移都会被政府利用，有何看法？这种担忧具体体现在私营公司应该愿意向政府提供什么？

像通用人工智能监管组织（GAR-reel）这样的机构应该，比如说，应该让人工智能模型去做与其签订合同的政府要求它们做的任何事情吗？通用人工智能监管组织（GROC）是否可以表示，比如，即使军方想做X，不，通用人工智能监管组织（GROC）也不会做？

马斯克: 我认为人工智能，或者也许是联邦航空管理局（FAAF）在人工智能和机器人技术方面可能出错的最大危险，在于政府。有意思。你看待事物的方式，比如那些反对企业或担心企业的人，他们真正应该最担心的是政府，因为政府在极限情况下也只是一家公司。

它是政府，它就它就它就政府就是那个拥有暴力垄断权的最大公司。所以我总是觉得很奇怪，有一种二分法：人们认为公司是坏的，但政府是而政府只不过是最大、最坏的那家公司。但人们有这种二分法。我总觉得政府可以好，但公司不好，这不是真的。公司的道德水准比政府高。

所以，我实际上认为，那是我们需要担忧的一件事。这政府是否不应该，比如，政府可能利用人工智能和机器人技术来压制民众。这是一种严重的担忧。

Dwarkesh: 作为一个从事人工智能和机器人技术研发的人，你如何，你如何，比如，你如何阻止这种情况发生？

马斯克: 我认为，如果你有一个有限的政府，如果你限制政府的权力，这实际上就是美国宪法的意图——限制政府的权力——那么你可能会比拥有更大政府时获得更好的结果。所以……但是机器人技术将可供所有政府使用，不只是所有政府。预测……比如，我可以谈谈终点是什么，或者很多年后的未来是什么，但沿着这条道路的路径是难以预测的。比如，如果文明发展，人工智能将远远超过全人类智慧的总和，而机器人将比人类更多。在这个过程中，会发生什么？这很难预测。

道德宪法与有限政府

Dwarkesh: 你做的一件事似乎就是说，你不被允许，无论哪个政府指数，你不被允许使用乐观主义者来做 X、Y、Z，就是写下一项政策。我认为你最近提到 GROC 应该有一个道德宪法。其中一项可能就是我们限制政府被允许使用这项先进技术做什么。

马斯克: 我们可以做什么将会做什么。从技术上讲，如果政策通过成为法律，那么他们就可以执行该法律，那么就很难不遵守该法律。我们能拥有的最好的东西是有限的政府，行政、司法和立法部门之间有适当的成本制衡。

Dwarkesh: 我猜我感到好奇的原因这一点在某些时候，限制似乎将来自于你，就像你有乐观主义者，你有空间 GPU，你有那个。你认为我会成为政府的领导者吗？

Dwarkesh: 或者你会得到，你会喜欢，SpaceX现在已经是这种情况了，对于政府非常关心将其某些卫星送入太空的关键事物，随便什么。就像它需要SpaceX一样。它它是必要的承包商。并且你正在构建越来越多的未来技术组成部分，这些组成部分将在不同行业中扮演类似的角色。你可能会拥有这种能力，来制定某种政策，以任何方式压制古典自由主义。我的公司不会以任何方式协助此事，或者，像那样的政策。

马斯克: 我将尽我所能，确保在我控制范围内的任何事情都能最大限度地为人类带来好的结果。我认为其他任何做法都是短视的，因为显然我是人类的一部分，所以我喜欢人类。支持人类，支持人类。

太空计算芯片设计：抗辐射与高温运行

Dwarkesh: 您提到Dojo 3将用于基于太空的计算。你真的读了我的话，我所说的。我不知道你是否知道推特（Twitter），但我知道你有大量的关注者。

马斯克: 确实送出去了。

Dwarkesh: 你怎么为太空设计这个芯片的？有什么变化？

马斯克: 我想你希望把它设计得更……更抗辐射，并在更高温度下运行。所以如果你将工作温度提高20%开尔文，你的散热器质量就可以减半。因此，在太空中以更高的温度运行是有帮助的。我指的是你可以做各种事情来屏蔽内存，但像神经网络对位翻转是非常有抵抗力的。

所以辐射发生的大部分情况就像随机的位翻转。但是如果你有一个多万亿参数的模型，出现几次比特翻转也无所谓。启发式程序将比巨大的参数文件更容易受到比特翻转的影响。所以我只是设计它在高温下运行，我认为你基本上会用和在地球上做事情相同的方式来做，只是让它运行得更努力一些。

算力算术：一亿个芯片的宏大计划

Dwarkesh: 太阳能电池阵列是卫星上大部分的重量所在。有没有办法使图形处理器比英伟达和张量处理器等计划做的更强大，这种能力在太空任务中是否会特别具有优势？

马斯克: 基本算术如果你每光罩（retical）能做到大约一千瓦，那么你需要，1亿个全光罩芯片才能达到100吉瓦。所以根据你的良率假设，这决定了你需要制造多少芯片。但很酷，如果你想，如果你想拥有100吉瓦的功率，你需要，1亿个芯片在运行，它们以每光罩持续一千瓦的速度运行。

一百个基本算术，一亿个芯片，这取决于，如果你，如果你看看像“黑球”（black ball）之类的芯片尺寸以及你可以从晶圆上得到多少，你每张晶圆大概能得到几十个或更少。所以你基本上，如果我们要每年都推出这些产品，你每个月就要生产数百万张晶圆。

这是台积电的计划，每月数百万张先进工艺节点的晶圆，这可能是一百万的数量级。我认为你还得考虑存储器，你要制造存储器晶圆。我认为台积电必须涵盖存储器，它必须涵盖逻辑、存储器和封装。我很好奇像英特尔（Gets）这样的人是如何开始的，这是人类迄今为止制造的最复杂的东西，而且很明显，如果有人能胜任这项任务，那就是你们。比如，你意识到这是一个瓶颈，然后你去找你的工程师，下一步是什么，你告诉他们做什么？

Dwarkesh: 我希望2030年每月有一百万个豁免。下一个是什么，比如，你，那是对的。你，比如，叫作 ASMR 吗？比如，那个男的是哪一个？

约翰: 下一步是什么？这要求太多了。

马斯克: 我们建一个小型的代工厂（fab），看看会发生什么。在小规模上犯我们的错误，然后再犯一个大错误。

约翰: 那个小型的代工厂建好了吗？

马斯克: 还没人们不会把这个秘密一直藏着的。那个聊天/信息肯定会泄露出去的。那会就像无人机盘旋在那该死的东西上方，你将能够实时在 X（指代平台）上看到它的建设进展。

所以，不，比如，我不知道，我们可能会徒劳无功，失败了。这就像不是保证成功，但因为我们想尝试制作，价值一亿（某种货币单位）的东西，我们需要，我们需要，我们想要 100 吉瓦的功率，以及 100 块能承受 100 吉瓦的芯片。所以，称之为，但到 2030 年。

所以那时，我们将获取尽可能多的芯片。只要我们的供应商愿意提供给我们。我实际上已经对台积电（TSM）、三星（Samsung）和美光（Micron）说过，我说，请更快地建造你们的晶圆厂。我们将保证向你们购买那些晶圆厂的产出。所以他们已经在以最快的速度行动了。就像不是说，明确地说，不是我们去，也不是我们加上他们，有一种观点认为，那些从事人工智能的人，希望尽快获得非常大量的芯片。

供应商的保守与周期伤痕

约翰: 然后许多上游供应商，包括晶圆厂，以及涡轮机制造商，生产扩张的速度并不快。不，你听到的解释是他们天性保守。他们可能是台湾人或德国人，这或许是故事的一部分，他们就是不相信，比如，这真的是解释，还是有其他原因？

马斯克: 这是合理的。如果有人在计算机存储器行业干了 30 年或 40 年。他们见过周期。他们见过，比如，繁荣和萧条，大约 10 次。所以，那是很多层留下的伤痕。所以就像在繁荣时期，看起来一切都会永远美好下去。然后就发生了崩盘，然后他们拼命地试图避免破产。然后又出现一次繁荣，接着又是另一次崩盘。

约翰: 你认为其他人应该去追求，但由于各种原因你目前没有去追求的其他想法有哪些？

马斯克: 有几家公司正在追求像制造芯片的新方法。但它们的规模化速度不够快。

约翰: 在人工智能领域，只是泛泛而言。

马斯克: 我会说，比如，人们应该去做他们发现自己高度有动力去做的事情，而不是去做我建议的某个想法。他们应该去做他们发现对自己个人有趣且有动力去做的事情。

但回到那个限制因素，他说了一个短语大约一百次。我所看到的在时间范围内的当前限制因素，在这个大约2029年、20年的时间范围内，未来三到四年内，是芯片。在这一年的时间框架内，涉及的是能源、电力生产和电力的事宜。

我还不清楚是否有足够的可用的电力来开启所有正在制造的AI芯片。到今年年底，我认为人们将真正遇到开启（芯片）的困难，就像芯片的产出将超过能够开启芯片的能力一样。

Dwarkesh: 您打算如何应对那个世界？

马斯克: 我们正努力加速电力生产。我猜这也许是XAI（我们的人工智能公司）可能成为领导者，希望是领导者的原因之一，就是因为我们在硬件方面很擅长，所以我们能够比其他人更快地开启更多的芯片。

一般来说，那些自称为实验室的公司所带来的创新，其思想是像一股流一样传递的，很少看到想法在人们之间来回传递有超过大约六个月的差异。所以我认为你会遇到硬件的瓶颈，然后，无论哪个公司能最快地扩展硬件规模，谁就能成为领导者。因此，我认为XCI（我们的人工智能公司）将能够最快地扩展硬件规模，因此最有可能成为领导者。

终语：选择乐观主义并犯错

约翰: 你是在开玩笑，或者对自己再次使用“限制因素”这个短语感到不自在。但我实际上认为这里面有深刻的道理。如果你回顾一下我们一路谈及的很多事情，这也许是个不错的收尾点。

比如，如果你想到一个老化的下层机构或公司，它会有某种瓶颈，但实际上并不会去解决它。马克和德里森曾说过：“大多数人愿意忍受任何程度的慢性疼痛，以避免急性疼痛。”感觉我们讨论的很多案例都在倾向于忍受急性疼痛，无论它是什么。我们必须弄清楚如何使用钢铁，或者我们必须弄清楚如何在太空中运行芯片，或者说，我们愿意承受短期的急性痛苦，来真正解决那个瓶颈。

马斯克: 所以，我有一个很高的痛苦耐受阈值，这对解决瓶颈是有帮助的。所以你知道我能说的一件事我认为未来会非常有趣。正如我所说，戴维斯人只去过，我真的在戴维斯实地考察，感觉就像在地面上呆了三个小时左右。

为了生活质量，选择乐观主义并犯错，总比选择悲观主义并正确要好。所以你的幸福感会如果你站在乐观主义这一边，你会比站在悲观主义这一边更快乐。所以我建议站在乐观主义这一边。

约翰: 很高兴听到这个。

马斯克: 太棒了。谢谢你做这些。

Dwarkesh: 谢谢你。很棒的耐力。希望这能应对疼痛和疼痛耐受力。
