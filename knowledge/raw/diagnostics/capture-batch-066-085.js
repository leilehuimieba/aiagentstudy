...
const TARGET_CAPTURES = Number(process.env.TARGET_CAPTURES || 20);
const OPENCLI_TIMEOUT_MS = Number(process.env.OPENCLI_TIMEOUT_MS || 45000);
const SKIP_URLS = new Set([
  'https://www.bestblogs.dev/video/5d4cc2f',
  'https://www.bestblogs.dev/video/6ff088c',
  'https://www.bestblogs.dev/article/44277004',
  'https://www.bestblogs.dev/video/d4d2d42',
]);
